...
class Library:
    ...
    def __init__(self, root):
        ...
        def iDisplayData():
            self.textDisplayR.insert(END,"\t",MType.get()+"\t\t"+Ref.get()+"\t"+Title.get()+"\t"+
        ...
        ListofBooks = ["Book 1", "Book 2", "Book 3", "Book 4", "Book 5", "Book 6", "Book 7", "Book 8", "Book 9",
        ...
        self.lblLabel = Label(FrameDetail, font=('arial', 10, 'bold'), pady=8,
                              text="Member Type \t Reference No. \t Title \t Firstname \t Surname \tAddress 1\tAddress 2\t Post Code\t Book Title\tData Borrowed\t Days on loan", )
        self.lblLabel.grid(row=0, column=0)

        self.textDisplayR = Text(FrameDetail, font=('arial', 12, 'bold'), width=121, height=4, padx=2, pady=4)
